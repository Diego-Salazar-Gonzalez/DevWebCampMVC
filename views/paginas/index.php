    ...
    <div class="speakers__grid">
        <?php foreach ($ponentes as $ponente) { ?>
            <div data-aos="<?php aos_animacion(); ?>" class="speaker">
                <picture>
                    <source srcset="img/speakers/<?php echo $ponente->imagen; ?>.webp" type="image/wepb">
                    <source srcset="img/speakers/<?php echo $ponente->imagen; ?>.png" type="image/png">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="img/speakers/<?php echo $evento->ponente->imagen; ?>.png" alt="Imagen evento">
                </picture>
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if (!empty($redes->github)) { ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com">
