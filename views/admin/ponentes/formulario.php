<fieldset class="formulario__fieldset">
    ...
    <?php if(isset($ponente->imagen_actual)) {?>
        ...
        <div class="formulario__imagen">
            ...
            <picture>
                <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.webp" type="image/wepb">
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="tags_input" class="formulario__label">Areas De Experiencia (seperadas por coma)</label>
        <input
            type="text"
            class="formulario__input"
            id="tags_input"
