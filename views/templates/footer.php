    ...
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae nam deserunt maxime sequi vel exercitationem eveniet, animi rerum facilis, officia qui minus illum repellat nemo tenetur eos quae. Odio, deserunt?
            </p>
        </div>
